...
// array ou objeto: manualmente informar o tipo da variavel utitlizada
...
const CreatePoint = () => {
  ...
  //Retorna os itemns selecionados
  useEffect(() => {
  ...
  //busca as UF na api do IBGE e retorna
  useEffect(() => {
    axios
      .get<IBGEUFResponse[]>(
  ...
  useEffect(() => {
    ...
    axios
      .get<IBGECityResponse[]>(
        `https://servicodados.ibge.gov.br/api/v1/localidades/estados/${selectdUf}/municipios`
      )
      .then((response) => {
